...
colorHomeBoxes =
    [ div [ class "col-start-1 row-start-1 border-4 row-span-6 border-red-800 col-span-6 rounded-lg" ] []
    , div [ class "col-start-10 row-start-1 border-4 row-span-6 border-green-800 col-span-6 rounded-lg" ] []
    , div [ class "col-start-1 row-start-10 border-4 row-span-6 border-blue-800 col-span-6 rounded-lg" ] []
    , div [ class "col-start-10 row-start-10 border-4 row-span-6 border-yellow-800  col-span-6 rounded-lg" ] []
