...
ludoGraph =
    Dict.fromList
        ...
        , ( 12, InCommonPathPosition 13 (PathEnd Green) )
        ...
        , ( 25, InCommonPathPosition 26 (PathEnd Yellow) )
        ...
        , ( 38, InCommonPathPosition 39 (PathEnd Blue) )
        ...
        , ( 51, InCommonPathPosition 52 (PathEnd Red) )
