...
var $author$project$HomeBoxes$mineClass = F2(
	function (model, color) {
		return _Utils_eq(model.selectedPlayer, color) ? ' shadow-outline' : '';
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					'col-start-1 row-start-1 border-4 row-span-6 border-red-800 col-span-6 rounded-lg ' + A2($author$project$HomeBoxes$mineClass, model, $author$project$LudoModel$Red))
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(
					'col-start-10 row-start-1 border-4 row-span-6 border-green-800 col-span-6 rounded-lg' + A2($author$project$HomeBoxes$mineClass, model, $author$project$LudoModel$Green))
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(
					'col-start-1 row-start-10 border-4 row-span-6 border-blue-800 col-span-6 rounded-lg' + A2($author$project$HomeBoxes$mineClass, model, $author$project$LudoModel$Blue))
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(
					'col-start-10 row-start-10 border-4 row-span-6 border-yellow-800  col-span-6 rounded-lg' + A2($author$project$HomeBoxes$mineClass, model, $author$project$LudoModel$Yellow))
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
