...
var $author$project$LudoModel$Blue = {$: 'Blue'};
...
var $author$project$LudoModel$defaultPositions = _List_fromArray(
	[
		...
		$author$project$LudoModel$InStartBoxPosition(4)),
		_Utils_Tuple2(
		$author$project$LudoModel$Yellow,
		$author$project$LudoModel$InStartBoxPosition(1)),
		_Utils_Tuple2(
		$author$project$LudoModel$Yellow,
		$author$project$LudoModel$InStartBoxPosition(2)),
...
var $author$project$Game$init = function (_v0) {
	return _Utils_Tuple2(
		{
			diceNum: 0,
			maxPlayers: $elm$core$Maybe$Just(2),
			messageToDisplay: '',
			participants: _List_fromArray(
				[$author$project$LudoModel$Red, $author$project$LudoModel$Green, $author$project$LudoModel$Yellow, $author$project$LudoModel$Blue]),
			positions: $author$project$LudoModel$defaultPositions,
			room: $elm$core$Maybe$Nothing,
			roomToJoin: '',
			selectedPlayer: $author$project$LudoModel$Red,
			turn: $author$project$LudoModel$Red
		},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$LudoModel$PathStar = {$: 'PathStar'};
var $author$project$LudoModel$PathStart = function (a) {
	return {$: 'PathStart', a: a};
};
var $author$project$Ports$integerToCommonPath = function (n) {
	switch (n) {
		...
		case 2:
			return $author$project$LudoModel$PathStart($author$project$LudoModel$Red);
		case 3:
			return $author$project$LudoModel$PathStart($author$project$LudoModel$Green);
		case 4:
			return $author$project$LudoModel$PathStart($author$project$LudoModel$Blue);
		case 5:
			return $author$project$LudoModel$PathStart($author$project$LudoModel$Yellow);
		case 6:
			return $author$project$LudoModel$PathEnd($author$project$LudoModel$Red);
		case 7:
			return $author$project$LudoModel$PathEnd($author$project$LudoModel$Green);
		case 8:
			return $author$project$LudoModel$PathEnd($author$project$LudoModel$Blue);
		case 9:
			return $author$project$LudoModel$PathEnd($author$project$LudoModel$Yellow);
		case 10:
		...
		case 3:
			return A2(
				...
				function () {
					switch (y) {
						case 1:
							return $author$project$LudoModel$Red;
						case 2:
							return $author$project$LudoModel$Blue;
						case 3:
							return $author$project$LudoModel$Green;
						case 4:
							return $author$project$LudoModel$Yellow;
						default:
							return $author$project$LudoModel$Red;
					}
				}(),
			...
			[
				...
				function (room) {
					return A3(
						...
						room,
						1,
						A2($elm$core$Maybe$withDefault, 2, model.maxPlayers));
				})
			]));
};
...
var $author$project$Ludo$canMove = F2(
	function (model, posInfo) {
		...
		var pos = _v0.b;
		return (!(!model.diceNum)) && (_Utils_eq(model.turn, playerColor) && function () {
			switch (pos.$) {
				case 'InStartBoxPosition':
					return model.diceNum === 6;
				case 'InHomePathPosition':
					var num = pos.b;
					return !((num + model.diceNum) > 6);
				default:
					return !(!model.diceNum);
			}
		}());
	});
...
var $author$project$LudoUpdate$getParticipantsByMaxPlayers = function (maxPlayers) {
	switch (maxPlayers) {
		case 2:
			return _List_fromArray(
				[$author$project$LudoModel$Red, $author$project$LudoModel$Yellow]);
		case 3:
			return _List_fromArray(
				[$author$project$LudoModel$Red, $author$project$LudoModel$Green, $author$project$LudoModel$Yellow]);
		default:
			return _List_fromArray(
				[$author$project$LudoModel$Red, $author$project$LudoModel$Green, $author$project$LudoModel$Yellow, $author$project$LudoModel$Blue]);
	}
		...
		while (true) {
			if (!toBeKilledList.b) {
							...
							function (_v2) {
								...
								return _Utils_Tuple2(
									...
									$author$project$LudoModel$InStartBoxPosition(
										A2($author$project$Ludo$getEmptyHomePosition, model.positions, color)));
							},
							model.positions);
					}
				}();
				var $temp$toBeKilledList = restOfTheList,
					...
					model,
					{positions: positionsAfterKilling});
						...
						return A2(
							...
							A2(
								...
								function (_v3) {
									var color = _v3.a;
									var p = _v3.b;
									return _Utils_eq(p, pos) && (!_Utils_eq(color, model.turn));
								},
								model.positions),
							model);
				}
...
var $author$project$Ludo$blueStartPosition = A2(
	$author$project$LudoModel$InCommonPathPosition,
	41,
	$author$project$LudoModel$PathStart($author$project$LudoModel$Blue));
var $author$project$Ludo$greenStartPosition = A2(
	$author$project$LudoModel$InCommonPathPosition,
	15,
	$author$project$LudoModel$PathStart($author$project$LudoModel$Green));
var $author$project$Ludo$redStartPosition = A2(
	$author$project$LudoModel$InCommonPathPosition,
	2,
	$author$project$LudoModel$PathStart($author$project$LudoModel$Red));
var $author$project$Ludo$yellowStartPosition = A2(
	$author$project$LudoModel$InCommonPathPosition,
	28,
	$author$project$LudoModel$PathStart($author$project$LudoModel$Yellow));
	...
	_List_fromArray(
		[
			...
			A2(
				$author$project$LudoModel$InCommonPathPosition,
				13,
				$author$project$LudoModel$PathEnd($author$project$LudoModel$Green))),
			_Utils_Tuple2(
			13,
			...
			A2(
				$author$project$LudoModel$InCommonPathPosition,
				26,
				$author$project$LudoModel$PathEnd($author$project$LudoModel$Yellow))),
			_Utils_Tuple2(
			26,
			...
			A2(
				$author$project$LudoModel$InCommonPathPosition,
				39,
				$author$project$LudoModel$PathEnd($author$project$LudoModel$Blue))),
			_Utils_Tuple2(
			39,
			...
			A2(
				$author$project$LudoModel$InCommonPathPosition,
				52,
				$author$project$LudoModel$PathEnd($author$project$LudoModel$Red))),
			_Utils_Tuple2(
			52,
...
var $author$project$Ludo$move = F3(
	function (posInfo, model, clickedPosition) {
		...
		while (true) {
			...
			if ((!_Utils_eq(model.turn, color)) || (!model.diceNum)) {
				return posInfo;
			} else {
				var pos = A2($author$project$Ludo$findInGraph, model.turn, currentPosition);
				var $temp$posInfo = _Utils_Tuple2(color, pos),
					$temp$model = _Utils_update(
					model,
					{diceNum: model.diceNum - 1}),
	...
	function (clickedPosition, model) {
		var maybeIndex = A2(
			...
			function (posInfo) {
				...
				return _Utils_eq(currentPosition, clickedPosition) && _Utils_eq(color, model.turn);
			},
			model.positions);
		...
		return _Utils_update(
			model,
			{
				...
				turn: ((model.diceNum === 6) || (A3($author$project$Ludo$killHappened, model.turn, model.positions, updatedPos) || A3($author$project$Ludo$goalPathReached, model.turn, model.positions, updatedPos))) ? model.turn : A2($author$project$Ludo$nextTurn, model, model.turn)
			});
	});
...
var $author$project$Ludo$moveAllType = F2(
	function (model, clickedPosition) {
		if (clickedPosition.$ === 'InStartBoxPosition') {
			var n = clickedPosition.a;
			return A3($author$project$Ludo$moveStartBoxPosition, model, model.turn, n);
		} else {
...
var $author$project$LudoUpdate$orderToPlayerColor = F2(
	function (model, order) {
		return A2(
			$elm$core$Maybe$withDefault,
			$author$project$LudoModel$Red,
			A2($elm_community$list_extra$List$Extra$getAt, order, model.participants));
	});
	...
	function (msg, model) {
		switch (msg.$) {
					...
					function () {
						...
						if (!movable.b) {
							return _Utils_update(
								...
								{
									diceNum: 0,
									turn: A2($author$project$Ludo$nextTurn, model, model.turn)
								});
						} else {
							if (!movable.b.b) {
								var _v2 = movable.a;
								...
								if (A2(
									...
									return _Utils_update(
										model,
										{diceNum: number, turn: model.turn});
								}
							}
						}
					}(),
			...
			case 'RollDice':
				return _Utils_Tuple2(
					model,
					$author$project$Ports$rollDice(_Utils_Tuple0));
			case 'RoomToBeJoinedChanged':
				var string = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'MaxPlayersChanged':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'OnRoomJoinClicked':
				return _Utils_Tuple2(
					model,
					$author$project$Ports$joinGame(model.roomToJoin));
			case 'OnStartGameClicked':
				return _Utils_Tuple2(
					model,
			...
			default:
				...
				var modelWithUpdatedParticipants = _Utils_update(
					model,
					{
						participants: $author$project$LudoUpdate$getParticipantsByMaxPlayers(maxPlayers)
					});
				var updatedModel = _Utils_update(
					modelWithUpdatedParticipants,
					{
						room: $elm$core$Maybe$Just(room),
						selectedPlayer: A2($author$project$LudoUpdate$orderToPlayerColor, modelWithUpdatedParticipants, order - 1)
					});
				return _Utils_Tuple2(
					_Utils_update(
						updatedModel,
...
var $author$project$LudoModel$MaxPlayersChanged = function (a) {
	return {$: 'MaxPlayersChanged', a: a};
};
var $author$project$LudoModel$OnRoomJoinClicked = {$: 'OnRoomJoinClicked'};
var $author$project$LudoModel$OnStartGameClicked = {$: 'OnStartGameClicked'};
var $author$project$LudoModel$RoomToBeJoinedChanged = function (a) {
	return {$: 'RoomToBeJoinedChanged', a: a};
};
...
var $author$project$Game$gameStartView = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(' w-10 w-full text-xl')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_Utils_eq(model.maxPlayers, $elm$core$Maybe$Nothing)),
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(model.roomToJoin)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$disabled(model.roomToJoin === '')
					]),
				_List_fromArray(
					[
...
var $author$project$Cell$Horizontal = {$: 'Horizontal'};
var $author$project$Cell$None = {$: 'None'};
var $author$project$Cell$Vertical = {$: 'Vertical'};
...
var $author$project$Cell$cell = F3(
	function (orientation, coinPosition, model) {
		...
		var colorClassName = _Utils_ap(
			...
			function () {
				if (coinPosition.$ === 'InCommonPathPosition') {
		...
		var coinsAtPosition = A2($author$project$Ludo$findCoinsAtCoinPosition, model.positions, coinPosition);
		var clickable = _Utils_eq(model.turn, model.selectedPlayer) && A2(
			$elm$core$List$any,
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('focus:outline-none text-white align-middle truncate text-center m-auto  rounded-full break-words ' + (' ' + focusClass)),
...
var $author$project$CommonPath$commonPath = function (model) {
	return _List_fromArray(
		[
			...
			A4($author$project$CommonPath$cellRow, $author$project$Cell$Horizontal, model, 0, 6)),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			$elm$core$List$reverse(
				A4($author$project$CommonPath$cellRow, $author$project$Cell$Vertical, model, 6, 12))),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			$elm$core$List$reverse(
				A4($author$project$CommonPath$cellRow, $author$project$Cell$None, model, 12, 13))),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A4($author$project$CommonPath$cellRow, $author$project$Cell$Vertical, model, 13, 19)),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A4($author$project$CommonPath$cellRow, $author$project$Cell$Horizontal, model, 19, 25)),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A4($author$project$CommonPath$cellRow, $author$project$Cell$None, model, 25, 26)),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			$elm$core$List$reverse(
				A4($author$project$CommonPath$cellRow, $author$project$Cell$Horizontal, model, 26, 32))),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A4($author$project$CommonPath$cellRow, $author$project$Cell$Vertical, model, 32, 38)),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A4($author$project$CommonPath$cellRow, $author$project$Cell$None, model, 38, 39)),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			$elm$core$List$reverse(
				A4($author$project$CommonPath$cellRow, $author$project$Cell$Vertical, model, 39, 45))),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			$elm$core$List$reverse(
				A4($author$project$CommonPath$cellRow, $author$project$Cell$Horizontal, model, 45, 51))),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A4($author$project$CommonPath$cellRow, $author$project$Cell$None, model, 51, 52))
		]);
};
var $author$project$LudoModel$RollDice = {$: 'RollDice'};
...
var $author$project$Dice$diceDiv = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('disabled:opacity-50 rounded-full hover:bg-gray-600 focus:outline-none focus:shadow-outline col-span-2 row-span-2 border p-2 m-2 animate__animated animate__bounce ' + positionClassWithAnimation),
				((!model.diceNum) && _Utils_eq(model.turn, model.selectedPlayer)) ? $elm$html$Html$Events$onClick($author$project$LudoModel$RollDice) : $elm$html$Html$Attributes$hidden(false)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				(!model.diceNum) ? 'roll' : $elm$core$String$fromInt(model.diceNum))
			]));
};
var $author$project$Game$endPath = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(' rounded-lg col-start-2 row-start-8 col-span-6 border-red-500 border-t border-b')
				]),
			A2(
				$elm$core$List$map,
				function (b) {
					return A3(
						...
						$author$project$Cell$Horizontal,
						A2($author$project$LudoModel$InHomePathPosition, $author$project$LudoModel$Red, b),
						model);
				},
				_List_fromArray(
					[1, 2, 3, 4, 5, 6]))),
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(' rounded-lg col-start-8 row-start-2 row-span-6  border-green-500 border-l border-r')
				]),
			A2(
				$elm$core$List$map,
				function (b) {
					return A3(
						$author$project$Cell$cell,
						$author$project$Cell$Vertical,
						A2($author$project$LudoModel$InHomePathPosition, $author$project$LudoModel$Green, b),
						model);
				},
				_List_fromArray(
					[1, 2, 3, 4, 5, 6]))),
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(' rounded-lg col-start-9 row-start-8 col-span-6 border-yellow-500 border-t border-b')
				]),
			A2(
				$elm$core$List$map,
				function (b) {
					return A3(
						$author$project$Cell$cell,
						$author$project$Cell$Horizontal,
						A2($author$project$LudoModel$InHomePathPosition, $author$project$LudoModel$Yellow, b),
						model);
				},
				_List_fromArray(
					[6, 5, 4, 3, 2, 1]))),
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(' rounded-lg col-start-8 row-start-9 row-span-6 border-blue-500 border-l border-r')
				]),
			A2(
				$elm$core$List$map,
				function (b) {
					return A3(
						$author$project$Cell$cell,
						$author$project$Cell$Vertical,
						A2($author$project$LudoModel$InHomePathPosition, $author$project$LudoModel$Blue, b),
						model);
				},
				_List_fromArray(
					[6, 5, 4, 3, 2, 1])))
...
var $author$project$HomeBoxes$blueHomeBoxes = _List_fromArray(
	[
		A2($author$project$HomeBoxes$homeBox, 'col-start-1 row-start-10', $author$project$LudoModel$Blue),
		A2($author$project$HomeBoxes$homeBox, 'col-start-4 row-start-10', $author$project$LudoModel$Blue),
		A2($author$project$HomeBoxes$homeBox, 'col-start-1 row-start-13', $author$project$LudoModel$Blue),
		A2($author$project$HomeBoxes$homeBox, 'col-start-4 row-start-13', $author$project$LudoModel$Blue)
	]);
var $author$project$HomeBoxes$colorHomeBoxes = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('col-start-1 row-start-1 border row-span-6 border-red-500 col-span-6 rounded-lg')
			]),
		_List_Nil),
		A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('col-start-10 row-start-1 border row-span-6 border-green-500 col-span-6 rounded-lg')
			]),
		_List_Nil),
		A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('col-start-1 row-start-10 border row-span-6 border-blue-500 col-span-6 rounded-lg')
			]),
		_List_Nil),
		A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('col-start-10 row-start-10 border row-span-6 border-yellow-500  col-span-6 rounded-lg')
			]),
		_List_Nil),
		A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('col-start-7 row-start-7 border row-span-3 border-gray-500  col-span-3 rounded-full')
			]),
		_List_Nil)
	]);
var $author$project$HomeBoxes$greenHomeBoxes = _List_fromArray(
	[
		A2($author$project$HomeBoxes$homeBox, 'col-start-10 row-start-1', $author$project$LudoModel$Green),
		A2($author$project$HomeBoxes$homeBox, 'col-start-13 row-start-1', $author$project$LudoModel$Green),
		A2($author$project$HomeBoxes$homeBox, 'col-start-10 row-start-4', $author$project$LudoModel$Green),
		A2($author$project$HomeBoxes$homeBox, 'col-start-13 row-start-4', $author$project$LudoModel$Green)
	]);
var $author$project$HomeBoxes$redHomeBoxes = _List_fromArray(
	[
		A2($author$project$HomeBoxes$homeBox, 'col-start-1 row-start-1', $author$project$LudoModel$Red),
		A2($author$project$HomeBoxes$homeBox, 'col-start-4 row-start-1', $author$project$LudoModel$Red),
		A2($author$project$HomeBoxes$homeBox, 'col-start-1 row-start-4', $author$project$LudoModel$Red),
		A2($author$project$HomeBoxes$homeBox, 'col-start-4 row-start-4', $author$project$LudoModel$Red)
	]);
var $author$project$HomeBoxes$yellowHomeBoxes = _List_fromArray(
	[
		A2($author$project$HomeBoxes$homeBox, 'col-start-10 row-start-10', $author$project$LudoModel$Yellow),
		A2($author$project$HomeBoxes$homeBox, 'col-start-13 row-start-10', $author$project$LudoModel$Yellow),
		A2($author$project$HomeBoxes$homeBox, 'col-start-10 row-start-13', $author$project$LudoModel$Yellow),
		A2($author$project$HomeBoxes$homeBox, 'col-start-13 row-start-13', $author$project$LudoModel$Yellow)
	]);
...
var $author$project$HomeCells$blueHomeCells = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Blue, 1, ' col-start-2 row-start-11  align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('🔵')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Blue, 2, ' col-start-5 row-start-11  align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('🔵')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Blue, 3, ' col-start-5 row-start-14  align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('🔵')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Blue, 4, ' col-start-2 row-start-14 align-middle '),
			_List_fromArray(
				[
					$elm$html$Html$text('🔵')
				]))
...
var $author$project$HomeCells$greenHomeCells = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Green, 1, ' col-start-11 row-start-2 align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('\uD83D\uDFE2')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Green, 2, ' col-start-14 row-start-2 align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('\uD83D\uDFE2')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Green, 3, ' col-start-14 row-start-5 align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('\uD83D\uDFE2')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Green, 4, ' col-start-11 row-start-5 align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('\uD83D\uDFE2')
				]))
...
var $author$project$HomeCells$redHomeCells = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Red, 1, ' col-start-2 row-start-2 align-middle text-center'),
			_List_fromArray(
				[
					$elm$html$Html$text('🔴')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Red, 2, ' col-start-5 row-start-2 align-middle text-center'),
			_List_fromArray(
				[
					$elm$html$Html$text('🔴')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Red, 3, ' col-start-5 row-start-5 align-middle text-center'),
			_List_fromArray(
				[
					$elm$html$Html$text('🔴')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Red, 4, ' col-start-2 row-start-5 align-middle text-center'),
			_List_fromArray(
				[
					$elm$html$Html$text('🔴')
				]))
...
var $author$project$HomeCells$yellowHomeCells = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Yellow, 1, ' col-start-11 row-start-11 align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('\uD83D\uDFE1')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Yellow, 2, ' col-start-14 row-start-11 align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('\uD83D\uDFE1')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Yellow, 3, ' col-start-14 row-start-14 align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('\uD83D\uDFE1')
				])),
			A2(
			$elm$html$Html$button,
			A4($author$project$HomeCells$clickOrHiddenAttribute, model, $author$project$LudoModel$Yellow, 4, ' col-start-11 row-start-14 align-middle'),
			_List_fromArray(
				[
					$elm$html$Html$text('\uD83D\uDFE1')
				]))
...
var $author$project$Game$gridHtml = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('grid text-4xl text-center grid-cols-15  grid-rows-15 m-auto p-3  h-wscreen w-screen lg:h-screen lg:w-hscreen')
			]),
		_Utils_ap(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.messageToDisplay)
					])),
				function () {
				var _v0 = model.room;
				if (_v0.$ === 'Just') {
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('my-8  text-center text-white text-6xl')
									]),
								_List_fromArray(
									[
										$author$project$Game$gridHtml(model),
										$elm$html$Html$text(
										'Room:  ' + A2($elm$core$Maybe$withDefault, '', model.room)),
										A2($elm$html$Html$br, _List_Nil, _List_Nil),
										$elm$html$Html$text(
										'turn: ' + $author$project$Game$turnToString(model.turn)),
										A2($elm$html$Html$br, _List_Nil, _List_Nil),
										$elm$html$Html$text(
										'me :' + $author$project$Game$turnToString(model.selectedPlayer))
									]))
							]));
				} else {
...
var $author$project$Game$main = $elm$browser$Browser$element(
	{init: $author$project$Game$init, subscriptions: $author$project$Game$subscriptions, update: $author$project$LudoUpdate$update, view: $author$project$Game$view});
_Platform_export({'Game':{'init':$author$project$Game$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"LudoModel.Msg","aliases":{},"unions":{"LudoModel.Msg":{"args":[],"tags":{"NewRandomNumber":["Basics.Int"],"MoveCoin":["LudoModel.Position"],"RollDice":[],"MakeMove":["LudoModel.Position"],"RoomToBeJoinedChanged":["String.String"],"MaxPlayersChanged":["String.String"],"OnRoomJoinClicked":[],"OnStartGameClicked":[],"UpdateMessage":["String.String"],"UpdateRoom":["String.String","Basics.Int","Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"LudoModel.Position":{"args":[],"tags":{"InCommonPathPosition":["Basics.Int","LudoModel.CommonPathPosition"],"InStartBoxPosition":["Basics.Int"],"InHomePathPosition":["LudoModel.PlayerColor","Basics.Int"]}},"String.String":{"args":[],"tags":{"String":[]}},"LudoModel.CommonPathPosition":{"args":[],"tags":{"PathStar":[],"PathStart":["LudoModel.PlayerColor"],"PathEnd":["LudoModel.PlayerColor"],"None":[]}},"LudoModel.PlayerColor":{"args":[],"tags":{"Red":[],"Green":[],"Blue":[],"Yellow":[]}}}}})}});}(this));