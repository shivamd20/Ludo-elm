...
var $author$project$Game$endPath = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('  col-start-2 row-start-8 col-span-5 bg-red-800  ')
				]),
			A2(
				$elm$core$List$map,
				function (b) {
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('  col-start-8 row-start-2 row-span-5  bg-green-800  ')
				]),
			A2(
				$elm$core$List$map,
				function (b) {
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('  col-start-10 row-start-8 col-span-5 bg-yellow-800  ')
				]),
			A2(
				$elm$core$List$map,
				function (b) {
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('  col-start-8 row-start-10 row-span-5 bg-blue-800 ')
				]),
			A2(
				$elm$core$List$map,
				function (b) {
