...
var $author$project$Game$gameStartView = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(' w-10 w-full text-xs ')
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Dice$diceDiv = function (model) {
	...
	return (!model.diceNum) ? A2(
		$elm$html$Html$img,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$src('dice.svg'),
				...
				$elm$html$Html$Attributes$class('disabled:opacity-50  hover:bg-gray-600  col-span-2 row-span-2  animate__animated animate__bounce text-center ' + positionClassWithAnimation)
			]),
		_List_Nil) : A2(
		$elm$html$Html$button,
		_List_fromArray(
...
var $author$project$Game$gridHtml = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('grid  text-center  grid-cols-15  grid-rows-15 m-auto p-3  h-wscreen w-screen lg:h-screen lg:w-hscreen')
			]),
		_Utils_ap(
